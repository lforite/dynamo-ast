...
class DefaultReadsTest extends Specification with ScalaCheck { def is = s2"""
 Specification for the default reads
  ...
  def readSFail = prop { dynamoType: DynamoType =>
  ...
  def readNFail = prop { dynamoType: DynamoType =>
  ...
  def readBOOLFail = prop { dynamoType: DynamoType =>
  ...
  def readLFail = prop { dynamoType: DynamoType =>
  ...
  def readMFail = prop { dynamoType: DynamoType =>
  ...
  def readNSFail = prop { dynamoType: DynamoType =>
  ...
  def readSSFail = prop { dynamoType: DynamoType =>
