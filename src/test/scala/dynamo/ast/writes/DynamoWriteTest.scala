...
class DynamoWriteTest extends Specification {
  def is = s2"""
...
"""
  ...
  def writeProduct = {
    val writer: DynamoWrite[(String, String)] =
      (DynamoWrite.write[String].at("field1"), DynamoWrite.write[String].at("field2")).contramapN[(String, String)](z => (z._1, z._2))
  ...
  def writeProductErase = {
    val writer: DynamoWrite[(String, String)] =
      (DynamoWrite.write[String].at("field1"), DynamoWrite.write[String].at("field1")).contramapN[(String, String)](z => (z._1, z._2))
